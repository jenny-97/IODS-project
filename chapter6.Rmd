...
Next,I'm going to fit the random intercept and random slope model onthe bprs data. This allows the linearregression fits fro each individualto differ in intercept and also in slope. This way we can accountfor individual subjects' bprsscores, and also how the change happens over time.